...
@Sql(scripts = {"classpath:testSchema.sql", "classpath:testData.sql"}, executionPhase = ExecutionPhase.BEFORE_TEST_METHOD) // Populate the test database before tests, and refresh each time 
...
public class GuestControllerIntegrationTest {
	...
	public void updateTest() throws Exception {
		...
		Guest expected = new Guest(1L, true, "Emmy Bradfield", "emily-bradfield@outlook.com", "root", true, true, false, false);
		String expectedJSON = mapper.writeValueAsString(expected);
